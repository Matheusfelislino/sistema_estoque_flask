"""Validation logic for produto (product) data."""
...
def validate_create(dados: dict) -> list[str]:
    """Validate payload for creating a new produto.
...
def validate_update(dados: dict) -> list[str]:
    """Validate payload for a full (PUT) update of a produto.
...
def validate_patch(dados: dict) -> list[str]:
    """Validate payload for a partial (PATCH) update of a produto.
